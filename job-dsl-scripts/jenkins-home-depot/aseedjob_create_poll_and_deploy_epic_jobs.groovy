    ...
    job("poll-and-deploy-${epic_name}-aem") {
        ...
        steps {
            ...
            maven {
                ...
                goals("install -Pqp -Dcrx.failOnError=false -Dcrx.url=http://172.24.102.175:4503 -DproxySet=true -DproxyHost=str-www-proxy2-qa -DproxyPort=8080 -Dcrx.password='admin' -pl '!homedepot-integration-tests,!test-content'")
